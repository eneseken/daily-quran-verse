...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _strings = {
    ...
    'customize_unlock_title': {
      'en': 'Unlock all themes',
      'tr': 'Tüm temaların kilidini aç',
      'ar': 'افتح جميع السمات',
      'de': 'Alle Themes freischalten',
      'fr': 'Débloquer tous les thèmes',
      'es': 'Desbloquear todos los temas',
      'ur': 'تمام تھیمز ان لاک کریں',
      'id': 'Buka semua tema',
    },
    'customize_unlock_subtitle': {
      'en': 'Get access to all\nbackgrounds',
      'tr': 'Tüm arka planlara\nerişim kazan',
      'ar': 'احصل على جميع\nالخلفيات',
      'de': 'Erhalte Zugriff auf alle\nHintergründe',
      'fr': 'Accédez à tous les\narrière-plans',
      'es': 'Obtén acceso a todos\nlos fondos',
      'ur': 'تمام بیک گراؤنڈز تک\nرسائی حاصل کریں',
      'id': 'Dapatkan akses ke semua\nlatar belakang',
    },
    'badge_free': {
      'en': 'FREE',
      'tr': 'ÜCRETSİZ',
